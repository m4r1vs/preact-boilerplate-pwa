...
export const DashboardIcon = ({ title }) => (
...
export const CafeteriaIcon = ({ title }) => (
...
export const ClassesIcon = ({ title }) => (
...
export const SettingsIcon = ({ title }) => (
...
export const FeedbackIcon = ({ title }) => (
...
export const DonationIcon = ({ title }) => (
...
export const ProjectsIcon = ({ title }) => (
